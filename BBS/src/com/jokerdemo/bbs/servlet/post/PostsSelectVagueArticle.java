...
/**
 * Servlet implementation class PostsSelectVagueArticle
 */
public class PostsSelectVagueArticle extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PostsSelectVagueArticle() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println(type);
		String var=request.getParameter("article");
		if(var==null) {
			Object articleObj=session.getAttribute("article");
			if(articleObj!=null) {
				var=(String)articleObj;	
			}
		}else {
			session.setAttribute("article", var);
		}
